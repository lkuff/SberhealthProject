...
- [x] Проверка открытия страницы контактов компании из футера сайта
- [x] Проверка открытия страницы личного кабинета
- [x] Проверка открытия модального окна с видео на странице 'онлайн-консультации'
- [x] Проверка открытия страницы вк с группой компании при клике на иконку VK
- [x] Проверка открытия страницы с диагностикой МРТ
...
## <img width="4%" title="Jenkins" src="images/logo/Jenkins.svg"> Удаленный запуск тестов в [Jenkins](https://jenkins.autotests.cloud/job/C16-leshkakuff-SberhealthProject/)
...
## <img width="4%" title="Allure Report" src="images/logo/Allure_Report.svg"> Отчет о результатах тестирования в [Allure Report](https://jenkins.autotests.cloud/job/C16-leshkakuff-SberhealthProject/1/allure/#)
...
<p align="center">
  <img title="Selenoid Video" src="images/gif/SberHealthGif.gif">
</p>
